...
export class Level extends Grid {
  ...
  static TILES = [
    { name: "floor", color: "#647687", lineWidth: 0, obstacle: false }, // 0
    { name: "wall" , color: "#999999", lineWidth: 0, obstacle: true  }, // 1
    { name: "door" , color: "#7C503F", lineWidth: 0, obstacle: false  }, // 2
    { name: "hall" , color: "#FFb9cd", lineWidth: 0, obstacle: false  }  // 3
  ];
  ...
  render(camera, pointLight) {
    ...
    img1.src = "resources/css/grass.jpg";
    //img1.onload = start;

    const img2 = new Image();
    img2.src = "resources/css/wall.jpeg";
    //img2.onload = start;

    const img3 = new Image();
    img3.src = "./hide-and-seek-master/resources/css/home_header_bg3.jpg";
    //img3.onload = start;
    
    const img4 = new Image();
    img4.src = "./hide-and-seek-master/resources/css/home_header_bg4.jpg";
    //img4.onload = start;

    var pat1, pat2, pat3, pat4;

      pat1 = ctx.createPattern(img1, '');
      pat2 = ctx.createPattern(img2, '');
      pat3 = ctx.createPattern(img3, '');
      pat4 = ctx.createPattern(img4, '');
      
      Level.TILES[0].color = pat1;
      Level.TILES[1].color = pat2;
      Level.TILES[2].color = pat3;
      Level.TILES[3].color = pat4;
      ...
      for (j = 0; j < this.rows; ++j) {
        ...
        && y < viewport.y2) {
          ...
          if(tile.lineWidth) {
            ...
            ctx.strokeStyle = computeColor(ctx.fillStyle, 1);
            ctx.stroke();
          }
        }
      }
